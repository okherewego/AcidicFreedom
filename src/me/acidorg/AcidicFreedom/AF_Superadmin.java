...
{	
    ...
    public AF_Superadmin(String name, List<String> ips, Date last_login, String custom_login_message, boolean is_senior_admin, List<String> console_aliases, boolean is_activated)
    {
    ...
    public AF_Superadmin(String name, ConfigurationSection section)
    {
        this.name = name.toLowerCase();
        this.ips = section.getStringList("ips");
        this.last_login = AF_Util.stringToDate(section.getString("last_login", AF_Util.dateToString(new Date(0L))));
    ...
    public String toString()
    {
        ...
        try
        {
            ...
            output.append("- Last Login: ").append(AF_Util.dateToString(this.last_login)).append("\n");
