...
{
    public final static Map<Player, UserInfo> userinfo = new HashMap<Player, UserInfo>();
    ...
    public static UserInfo getPlayerData(Player p)
    {
        ...
        if (playerdata == null)
        {
            Iterator<Entry<Player, UserInfo>> it = userinfo.entrySet().iterator();
            while (it.hasNext())
            {
                Entry<Player, UserInfo> pair = it.next();
                UserInfo playerdata_test = pair.getValue();
        ...
        if (playerdata == null)
        {
            ...
            UserInfo.userinfo.put(p, playerdata);
        }
